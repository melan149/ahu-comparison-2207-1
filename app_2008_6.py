        ...
        if item["type"] == "header":
            ...
            if chart_name == "unit_area_chart" and not unit_area_chart_displayed:
                ...
                if chart_data:
                    ...
                    fig1 = px.line(chart_df, x="X", y="Y", color="Label", line_group="Label", markers=True, color_discrete_map=color_map)
                ...
                if chart_data:
                    ...
                    chart_df = pd.DataFrame(chart_data).sort_values(by=['Label', 'Order'])
                    fig2 = px.line(chart_df, x="X", y="Y", color="Label", line_group="Label", markers=True, color_discrete_map=color_map)
                ...
                if chart_data:
                    ...
                    chart_df = pd.DataFrame(chart_data).sort_values(by=['Label', 'Order'])
                    fig3 = px.line(chart_df, x="X", y="Y", color="Label", line_group="Label", markers=False, color_discrete_map=color_map)
                ...
                if chart_data:
                    ...
                    fig_heater = px.bar(chart_df, x="Capacity Range", y="Value (kW)", color="Selection", barmode="group", color_discrete_map=color_map)
